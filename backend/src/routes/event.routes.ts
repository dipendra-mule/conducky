...
router.get('/slug/:slug/users', requireRole(['Reporter', 'Responder', 'Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
...
router.get('/slug/:slug/users/:userId', requireRole(['Responder', 'Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
...
router.get('/slug/:slug/users/:userId/activity', requireRole(['Responder', 'Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { slug, userId } = req.params;
...
router.get('/slug/:slug/users/:userId/reports', requireRole(['Responder', 'Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { slug, userId } = req.params;
    const page = parseInt(req.query.page as string) || 1;
    const limit = parseInt(req.query.limit as string) || 20;
...
router.patch('/slug/:slug/users/:userId', requireRole(['Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { slug, userId } = req.params;
    ...
    // Validate role enum
    const validRoles = ['System Admin', 'Event Admin', 'Responder', 'Reporter'];
...
router.delete('/slug/:slug/users/:userId', requireRole(['Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { slug, userId } = req.params;
...
router.get('/slug/:slug/stats', requireRole(['Responder', 'Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { slug } = req.params;
...
router.get('/slug/:slug/cardstats', requireRole(['Reporter', 'Responder', 'Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { slug } = req.params;
    const user = req.user as any;
...
router.get('/slug/:slug/user-role', requireRole(['Reporter', 'Responder', 'Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { slug } = req.params;
    const user = req.user as any;
...
// Assign role to user
router.post('/:eventId/roles', requireRole(['Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { eventId } = req.params;
...
router.delete('/:eventId/roles', requireRole(['Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { eventId } = req.params;
    const { userId, roleName } = req.body;
...
router.post('/:eventId/reports', requireRole(['Reporter', 'Responder', 'Event Admin', 'System Admin']), uploadEvidence.array('evidence'), validateUploadedFiles, async (req: Request, res: Response): Promise<void> => {
  try {
    const { eventId } = req.params;
...
router.get('/:eventId/reports/:reportId/state-history', requireRole(['Event Admin', 'System Admin', 'Responder', 'Reporter']), async (req: Request, res: Response): Promise<void> => {
  try {
...
router.patch('/:eventId/reports/:reportId/state', requireRole(['Event Admin', 'System Admin', 'Responder']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { eventId, reportId } = req.params;
...
// Update report title
router.patch('/:eventId/reports/:reportId/title', requireRole(['Event Admin', 'System Admin', 'Reporter']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { eventId, reportId } = req.params;
...
router.patch('/:eventId/reports/:reportId/location', requireRole(['Event Admin', 'System Admin', 'Reporter', 'Responder']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { eventId, reportId } = req.params;
...
router.patch('/:eventId/reports/:reportId/contact-preference', requireRole(['Event Admin', 'System Admin', 'Reporter']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { eventId, reportId } = req.params;
...
// Update report type
router.patch('/:eventId/reports/:reportId/type', requireRole(['Event Admin', 'System Admin', 'Reporter', 'Responder']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { eventId, reportId } = req.params;
    const { type } = req.body;
...
router.patch('/:eventId/reports/:reportId/description', requireRole(['Event Admin', 'System Admin', 'Reporter']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { eventId, reportId } = req.params;
...
router.patch('/:eventId/reports/:reportId/incident-date', requireRole(['Event Admin', 'System Admin', 'Reporter', 'Responder']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { eventId, reportId } = req.params;
...
router.patch('/:eventId/reports/:reportId/parties', requireRole(['Event Admin', 'System Admin', 'Reporter', 'Responder']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { eventId, reportId } = req.params;
...
router.post('/:eventId/reports/:reportId/evidence', requireRole(['Event Admin', 'System Admin', 'Responder']), uploadEvidence.array('evidence'), async (req: Request, res: Response): Promise<void> => {
  try {
    const { reportId } = req.params;
...
router.delete('/:eventId/reports/:reportId/evidence/:evidenceId', requireRole(['Event Admin', 'System Admin', 'Responder']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { evidenceId } = req.params;
...
// Upload event logo
router.post('/:eventId/logo', requireRole(['Event Admin', 'System Admin']), uploadLogo.single('logo'), async (req: Request, res: Response): Promise<void> => {
  try {
    const { eventId } = req.params;
...
router.patch('/slug/:slug', requireRole(['Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { slug } = req.params;
...
router.get('/slug/:slug/reports', requireRole(['Reporter', 'Responder', 'Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { slug } = req.params;
...
router.get('/slug/:slug/reports/export', requireRole(['Reporter', 'Responder', 'Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { slug } = req.params;
...
router.post('/slug/:slug/reports/bulk', requireRole(['Responder', 'Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { slug } = req.params;
...
router.post('/slug/:slug/reports', requireRole(['Reporter', 'Responder', 'Event Admin', 'System Admin']), uploadEvidence.array('evidence'), async (req: Request, res: Response): Promise<void> => {
  try {
    const { slug } = req.params;
    const { type, description, title, incidentAt, parties, location, contactPreference, urgency } = req.body;
...
router.post('/slug/:slug/logo', requireRole(['Event Admin', 'System Admin']), uploadLogo.single('logo'), async (req: Request, res: Response): Promise<void> => {
  try {
    const { slug } = req.params;
    const logoFile = req.file;
...
router.get('/slug/:slug/invites', requireRole(['Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { slug } = req.params;
...
router.post('/slug/:slug/invites', requireRole(['Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { slug } = req.params;
...
router.patch('/slug/:slug/invites/:inviteId', requireRole(['Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
...
router.post('/slug/:slug/reports/:reportId/comments', requireRole(['Reporter', 'Responder', 'Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { slug, reportId } = req.params;
    ...
    const hasResponderRole = roles.some((role: string) => ['Event Admin', 'Responder', 'System Admin'].includes(role));
...
router.get('/slug/:slug/reports/:reportId/comments', requireRole(['Reporter', 'Responder', 'Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { slug, reportId } = req.params;
    const page = parseInt(req.query.page as string) || 1;
    const limit = parseInt(req.query.limit as string) || 20;
...
router.patch('/slug/:slug/reports/:reportId', requireRole(['Responder', 'Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { slug, reportId } = req.params;
    const updateData = req.body;
...
router.patch('/slug/:slug/reports/:reportId/title', requireRole(['Reporter', 'Responder', 'Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { slug, reportId } = req.params;
    const { title } = req.body;
...
router.post('/slug/:slug/reports/:reportId/evidence', requireRole(['Reporter', 'Responder', 'Event Admin', 'System Admin']), uploadEvidence.array('evidence'), async (req: Request, res: Response): Promise<void> => {
  try {
    const { slug, reportId } = req.params;
    ...
    const report = reportResult.data!.report;
    const roles = accessResult.data!.roles;
    const isReporter = roles.includes('Reporter') && !roles.some((role: string) => ['Responder', 'Event Admin', 'System Admin'].includes(role));
...
router.get('/slug/:slug/reports/:reportId/evidence', requireRole(['Reporter', 'Responder', 'Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
    const { slug, reportId } = req.params;
...
router.delete('/slug/:slug/reports/:reportId/evidence/:evidenceId', requireRole(['Responder', 'Event Admin', 'System Admin']), async (req: Request, res: Response): Promise<void> => {
  try {
