...
export default function TeamMemberProfile() {
  ...
  const getRoleColor = (role: string) => {
    switch (role.toLowerCase()) {
      case 'system admin': return 'bg-red-100 text-red-800 border-red-200 dark:bg-red-900/20 dark:text-red-300 dark:border-red-800';
      case 'event admin': return 'bg-blue-100 text-blue-800 border-blue-200 dark:bg-blue-900/20 dark:text-blue-300 dark:border-blue-800';
